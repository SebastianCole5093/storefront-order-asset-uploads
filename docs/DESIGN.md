...
> Design notes for **storefront-order-asset-uploads** — a runnable python example that FastAPI service that issues order-aware presigned PUT URLs for receipts, fulfillment photos, and customer updates.
...
- **Feature code** — the actual task: order-asset-browser-upload.
